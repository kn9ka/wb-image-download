...
## Corpus Check
- 55 files · ~32,188 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 285 nodes · 326 edges · 32 communities (25 shown, 7 thin omitted)
...
Cohesion: 0.23
Nodes (12): getPhotoMedia(), getVideoMedia(), downloadMedia(), DownloadMediaParams, getVideoSegmentNames(), saveFile(), ProductMedia, ProductMediaType (+4 more)
...
## Knowledge Gaps
- **158 isolated node(s):** `$schema`, `.agents/skills/`, `README.md`, `graphify-out/`, `skills-lock.json` (+153 more)
...
- `HomePage()` (4× useful, score=3.997635802)
- `getProductMedia()` (3× useful, score=2.998577119) _(code changed — re-verify)_
- `getProductMedia.ts` (3× useful, score=2.99840175) _(code changed — re-verify)_
- `useForm()` (2× useful, score=1.998644286)
- `MediaDownloadDialog()` (2× useful, score=1.998381704) _(code changed — re-verify)_
- `HomePage.tsx` (2× useful, score=1.9978274)
- `MediaDownloadDialog.tsx` (2× useful, score=1.9978274) _(code changed — re-verify)_
